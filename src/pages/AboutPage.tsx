      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-12">
            <h2 className="font-serif text-3xl font-bold text-espresso-900 mb-6">Biz Kimiz?</h2>
          ...
          <section className="mb-12">
            <h2 className="font-serif text-3xl font-bold text-espresso-900 mb-6">Değerlerimiz</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-linen-200 p-6 rounded-xl border border-mist-300">
                <div className="w-12 h-12 bg-gold-100 rounded-lg flex items-center justify-center mb-4">
                  <Shield className="h-6 w-6 text-gold-800" />
                </div>
                <h3 className="font-semibold text-espresso-900 text-lg mb-2">Güvenilirlik</h3>
              ...
              <div className="bg-linen-200 p-6 rounded-xl border border-mist-300">
                <div className="w-12 h-12 bg-gold-100 rounded-lg flex items-center justify-center mb-4">
                  <Award className="h-6 w-6 text-gold-800" />
                </div>
                <h3 className="font-semibold text-espresso-900 text-lg mb-2">Kalite</h3>
                <p className="text-espresso-700">
              ...
              <div className="bg-linen-200 p-6 rounded-xl border border-mist-300">
                <div className="w-12 h-12 bg-gold-100 rounded-lg flex items-center justify-center mb-4">
                  <Store className="h-6 w-6 text-gold-800" />
                </div>
                <h3 className="font-semibold text-espresso-900 text-lg mb-2">Gelenek</h3>
                <p className="text-espresso-700">
              ...
              <div className="bg-linen-200 p-6 rounded-xl border border-mist-300">
                <div className="w-12 h-12 bg-gold-100 rounded-lg flex items-center justify-center mb-4">
                  <Truck className="h-6 w-6 text-gold-800" />
                </div>
                <h3 className="font-semibold text-espresso-900 text-lg mb-2">Özenli Hizmet</h3>
                <p className="text-espresso-700">
          ...
          <section className="mb-12">
            <h2 className="font-serif text-3xl font-bold text-espresso-900 mb-6">Hikayemiz</h2>
            <p className="text-espresso-800 leading-relaxed mb-4">
          ...
          <section className="bg-olive-800 text-linen-100 p-8 rounded-xl">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              <div>
                ...
                <p className="text-linen-300">Antika Dükkanı</p>
              </div>
              <div>
                <p className="text-3xl font-bold text-gold-500">1000+</p>
                <p className="text-linen-300">Ürün</p>
              </div>
              <div>
                <p className="text-3xl font-bold text-gold-500">5000+</p>
                <p className="text-linen-300">Mutlu Müşteri</p>
              </div>
              <div>
                <p className="text-3xl font-bold text-gold-500">81</p>
                <p className="text-linen-300">İl'e Teslimat</p>
              </div>
            </div>
          </section>
        </div>
