...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Features */}
      <section className="py-12 bg-linen-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              <div className="w-14 h-14 bg-gold-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <Store className="h-7 w-7 text-gold-800" />
              </div>
              <h3 className="font-semibold text-espresso-900 text-lg">Güvenilir Dükkanlar</h3>
              <p className="mt-2 text-espresso-700">İstanbul'un en seçkin antikacıları tek çatı altında</p>
            </div>
            <div className="text-center p-6">
              <div className="w-14 h-14 bg-gold-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <Package className="h-7 w-7 text-gold-800" />
              </div>
              <h3 className="font-semibold text-espresso-900 text-lg">Özenli Paketleme</h3>
              <p className="mt-2 text-espresso-700">Tüm ürünler sigortalı ve özenle paketlenerek gönderilir</p>
            </div>
            <div className="text-center p-6">
              <div className="w-14 h-14 bg-gold-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <Truck className="h-7 w-7 text-gold-800" />
              </div>
              <h3 className="font-semibold text-espresso-900 text-lg">Güvenli Teslimat</h3>
              <p className="mt-2 text-espresso-700">Türkiye'nin her yerine güvenli kargo seçenekleri</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Featured Products */}
      <section className="py-16 lg:py-24 bg-linen-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="mt-2 text-espresso-700">En son eklenen nadide parçalar</p>
            </div>
            <Link to="/products">
          ...
          {productsLoading ? (
            ...
            <div className="text-center py-12 bg-linen-200 rounded-xl">
              <p className="text-espresso-700">{TR.products.noProducts}</p>
            </div>
          ) : (
      ...
      {/* Featured Shops */}
      <section className="py-16 lg:py-24 bg-olive-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="font-serif text-3xl font-bold text-espresso-900">
              ...
              <p className="mt-2 text-espresso-700">İstanbul'un köklü antika dükkanları</p>
            </div>
            <Link to="/shops">
              <Button variant="ghost">
                Tümünü Gör
          ...
          {shopsLoading ? (
            ...
            <div className="text-center py-12 bg-linen-200 rounded-xl">
              <p className="text-espresso-700">{TR.shops.noShops}</p>
            </div>
          ) : (
      ...
      {/* CTA Section */}
      <section className="py-16 lg:py-24 bg-gradient-to-r from-olive-700 to-olive-800 text-linen-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-serif text-3xl md:text-4xl font-bold mb-4">
            Tarihi Eserinizi Bulun
          </h2>
          <p className="text-lg text-linen-300 mb-8 max-w-2xl mx-auto">
